...
<body>
    <div class="container">
        ...
        <div class="bookmarklet-section">
            <a href="javascript:(function(){var left=Math.floor(screen.width/2-400);var top=Math.floor(screen.height/2-225);var w=window.open('https://app.stasher.dev/','stasher','width=800,height=450,resizable=yes,scrollbars=no,status=no,location=no,toolbar=no,menubar=no,left='+left+',top='+top);if(w){w.focus();}else{alert('Popup blocked – please allow popups for this site');}})();" class="bookmarklet-link">stasher</a>
